<div class="container my-5 w-50">
    ...
    if($_GET['controller']=='book'){
        echo '<form action="index.php?controller=book&action=borrow" method="post">';
    }else {
        echo '<form action="index.php?controller=history&action=borrowingbookbyid" method="post">';
    }
    ?>
