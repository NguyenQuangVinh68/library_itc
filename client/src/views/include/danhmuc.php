        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3" style="text-align:center">
                    ...
                    <a class="category-book" href="index.php?controller=book&action=filtercategory4"><i class="fa fa-leanpub fa-4x"
                           ></i><br>Đồ án TN ĐH-CĐ</a>

                </div>
                <div class="col-lg-3" style="text-align:center">
                    <a class="category-book" href="index.php?controller=book&action=filtercategory5"><i class="fa fa-pencil-square-o fa-4x"
                           ></i><br>Sách Giáo Trình</a>

                </div>
                <div class="col-lg-3" style="text-align:center">
                    <a class="category-book" href="index.php?controller=book&action=filtercategory6"><i class="fa fa-newspaper-o fa-4x"
                           ></i><br>Báo Tạp Chí</a>
